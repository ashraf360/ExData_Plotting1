...
par(mfrow=c(2,2))
plot(d2$DT2, d2$Global_active_power, type = "l", xlab = "", ylab="Global Active Power")
plot(d2$DT2, d2$Voltage, type = "l", xlab = "datetime", ylab="Voltage")



plot(d2$DT2, d2$Sub_metering_1, type = "l", xlab= "", ylab="Energy sub metering")

lines(d2$DT2,d2$Sub_metering_2, col="red")
lines(d2$DT2,d2$Sub_metering_3, col="blue")
legend("topright", legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col=c("black", "red", "blue"), lty=1)

plot(d2$DT2, d2$Global_reactive_power, type = "l", xlab = "datetime", ylab="Global_reactive_power")
